...
class Hash extends $pb.GeneratedMessage {
  ...
  static $core.List<Hash> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
...
class BootValidation extends $pb.GeneratedMessage {
  ...
  static $core.List<BootValidation> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
...
class InitCommand extends $pb.GeneratedMessage {
  ...
  static $core.List<InitCommand> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
...
class ResetCommand extends $pb.GeneratedMessage {
  ...
  static $core.List<ResetCommand> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
...
class Command extends $pb.GeneratedMessage {
  ...
  static $core.List<Command> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
...
class SignedCommand extends $pb.GeneratedMessage {
  ...
  static $core.List<SignedCommand> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
...
class Packet extends $pb.GeneratedMessage {
  ...
  static $core.List<Packet> createRepeated() => [];
  @$core.pragma('dart2js:noInline')
